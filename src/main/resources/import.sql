...
INSERT INTO producto (nombre, precio, stock, descripcion, categoria_id) VALUES
    ('Laptop HP Pavilion', 899.99, 15, 'Laptop con 8GB RAM y SSD 256GB', 1),
    ('Smartphone Samsung Galaxy S21', 749.50, 30, 'Pantalla AMOLED 6.2 pulgadas', 1),
    ('Auriculares Sony WH-1000XM4', 349.99, 25, 'Cancelación de ruido premium',1),
    ('Libro "Cien años de soledad"', 19.99, 50, 'Edición especial tapa dura', 4),
    ('Zapatillas Nike Air Max', 129.95, 40, 'Talla 42, color blanco', 3),
    ('Cafetera Nespresso Essenza', 99.00, 20, 'Compacta y automática', 2),
    ('Mochila The North Face', 79.99, 35, 'Resistente al agua, 30L', 3),
    ('Teclado Mecánico Logitech G Pro', 149.99, 18, 'Switches Cherry MX Red', 1),
    ('Set de Lego Star Wars', 59.95, 12, 'Millennium Falcon edición coleccionista', 1),
    ('Crema Hidratante Cerave', 12.49, 60, 'Para pieles sensibles, 473ml', 5);
...
INSERT INTO item(cantidad , carrito_id,producto_id,tipo_item) VALUES
    (10,1,1,'carrito'),
    (10,2,2,'carrito'),
    (10,1,3,'carrito');
...
INSERT INTO item(cantidad , pedido_id,producto_id,tipo_item) VALUES
    (10,1,1,'pedido'),
    (10,2,2,'pedido'),
    (10,1,3,'pedido');